...
const Aspirations = require('../models/Aspiration');
...
async function run() {
    ...
    // for (let i = 0; i < 80; i++) {
    //     const positionIndices = getRandomElements(48, 3);
    //     const aspiration = {
    //         "_id": students[i]._id,
    //         "promised_positions": [
    //             {"_id": positions[positionIndices[0]]._id },
    //             {"_id": positions[positionIndices[1]]._id },
    //             {"_id": positions[positionIndices[2]]._id },
    //         ]
    //     };
    //     await Aspirations.create(aspiration); 
    // }
    // const teachers = [];
    ...
    const accounts = [];
    for (let i = 0; i < 18; i++) {
        const hashedPassword = await hashPassword(`B${i}-123456`);
